...
public class Server {
/**
 * Return all the jobs handled by the Server
...
/**
 * Filters the server's job list
 * @param Filter to filter a list of ran jobs
 * @return array of Job
...
/**
 * Get a array of queued or halted jobs
 * @return array of job
 * @throws java.io.IOException
 * @throws java.lang.InterruptedException
 */
...
p.getOutputStream().close();
    ...
    /**
     * Returns cluster handled by the server
     * @return Cluster
