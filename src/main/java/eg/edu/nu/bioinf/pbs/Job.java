 ...
 * @version 1.0
 * 
 * This class is a representation of a PBS Job.
 */
public class Job {
    ...
    /**
     * Creates a job by giving it a name and a path of a shell file
     * @param JobName Job name
     * @param ShellFile file to submit to the server
     * 
     */
...
/**
 * find list of jobs where there names contains a substring
 * @param Name : Name to find
 * @param ExactMatch : if exact match is required
 * @return array of string containing found Jobs IDs
 * @throws IOException
 * @throws InterruptedException
 */
...
//                    System.out.println("value = " + value);
    ...
    /**
     * used to get information about an job from the server
     * @param JobID
...
public String toHTMLString()
{
    ...
    /**
     * @param executableFile the executableFile to submit to pbs
     */
    ...
    /**
     * @param wallTime the maximum time for job
     */
    ...
    /**
     * @param queue the queue to submit job to
     */
    ...
    /**
     * @param executeNode the node which executes the job
     */
